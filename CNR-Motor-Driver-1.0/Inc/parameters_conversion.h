...
#define M1_ENC_IC_FILTER_LL LL_TIM_IC_FILTER_FDIV32_N8  /* max HW input filter vs PWM noise */
#define M1_ENC_IC_FILTER   15  /* max glitch rejection */
#define SPD_ENC_TIM_M1_IRQHandler               TIM4_IRQHandler

#define LPF_FILT_CONST                      ((int16_t)(32767 * 0.5))

/* MMI Table Motor 1 MAX_MODULATION_65_PER_CENT */
#define MAX_MODULE                          (uint16_t)((65* 32767)/100)
